...
from SweetyMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
...
from SweetyMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
...
@app.on_callback_query(filters.regex("SweetyPlaylists") & ~BANNED_USERS)
@languageCB
