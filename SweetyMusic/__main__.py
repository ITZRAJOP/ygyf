...
async def init():
    ...
    try:
        await Sweety.stream_call(
            "https://telegra.ph/file/3f7f22fdd0568b1b572e7.jpg"
        )
    ...
    LOGGER("SweetyMusic").info("Music Bot Started Successfully ❣️")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("SweetyMusic").info("Stopping Music Bot, Bhakk Bhosdike (Gaand Maraa Tu)")
